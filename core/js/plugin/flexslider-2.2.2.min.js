...
jQuery(window).load(function() {
  ...
  jQuery('.bizzex-flexslider-carousel').flexslider({
    ...
    itemWidth: 100,
    itemMargin: 1,
    asNavFor: '#bizzex-slides-carousel-id',
	start: function(slider) {
		jQuery('.bizzex-flexslider-carousel .bizzex-slides').css("display","block");
	  if (slider.pagingCount == 1) slider.addClass('flex-centered');
	  if (jQuery('.bizzex-flexslider-carousel .bizzex-slides li').length*101 <= jQuery('.bizzex-flexslider-carousel .flex-viewport').width() ) {
		  jQuery('.bizzex-flexslider-carousel .flex-direction-nav').css('display','none');
  ...
  //Initialize FlexSlider
	jQuery('.bizzex-flexslider-featured-gallery').flexslider({
		pauseOnHover: true,
	...
	jQuery('.bizzex-flexslider').each(function() {
		var first_image_height = jQuery(this).find('ul.bizzex-slides li:first-child img').css('height');
